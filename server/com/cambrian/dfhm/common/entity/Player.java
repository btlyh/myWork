...
public class Player extends Sample implements Actor {
	...
	public void init() {
		...
		bCard = new BattleCard(card.getId(), card.getName(), card.getAvatar(),
				card.getTinyAvatar(), card.getLevel(), card.getAtt(), card
						.getSkillRate(), card.getAttRange(), 34801, card
						.getMaxHp(), card.getCurHp(), 0, card.getAimType(),
		...
		bCard = new BattleCard(card.getId(), card.getName(), card.getAvatar(),
				card.getTinyAvatar(), card.getLevel(), card.getAtt(), card
						.getSkillRate(), card.getAttRange(), 34201, card
						.getMaxHp(), card.getCurHp(), 1, card.getAimType(),
				card.getCritRate(), card.getDodgeRate(), 0, card.getType());
		...
		bCard = new BattleCard(card.getId(), card.getName(), card.getAvatar(),
				card.getTinyAvatar(), card.getLevel(), card.getAtt(), card
						.getSkillRate(), card.getAttRange(), card.getSkillId(),
				card.getMaxHp(), card.getCurHp(), 2, card.getAimType(), card
						.getCritRate(), card.getDodgeRate(), 0, card.getType());
		...
		bCard = new BattleCard(card.getId(), card.getName(), card.getAvatar(),
				card.getTinyAvatar(), card.getLevel(), card.getAtt(), card
						.getSkillRate(), card.getAttRange(), card.getSkillId(),
				card.getMaxHp(), card.getCurHp(), 3, card.getAimType(), card
						.getCritRate(), card.getDodgeRate(), 0, card.getType());
		...
		bCard = new BattleCard(card.getId(), card.getName(), card.getAvatar(),
				card.getTinyAvatar(), card.getLevel(), card.getAtt(), card
						.getSkillRate(), card.getAttRange(), card.getSkillId(),
				card.getMaxHp(), card.getCurHp(), 4, card.getAimType(), card
						.getCritRate(), card.getDodgeRate(), 0, card.getType());
	...
	public void setVipCfg() {
		...
		if (vip == null)
			vip = (VipCfg) Sample.factory.newSample(vipSid);
