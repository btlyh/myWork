...
public class RankingsManager
{
	...
	/** 计时器：更新排行信息 */
	private static long TIME = TimeKit.DAY_MILLS;
...
//		}
	 ...
	 * 合并数据库排行和在线排行
	 * 
	 * @param onlineRankings
	 *            在线的排行信息
	 * @param dbRankings
	 *            数据库中的排行信息
	 * @return 合并完成后的排行
	 */
	private Rankings mergeRankings(Rankings onlineRankings, Rankings dbRankings)
	{
		...
		List<RankInfo> challenge = mergeList(dbRankings.getChallengeRankings(),
